<?php  addProduct(); // this function is actually disabled in active website 
...
<div class="col-md-5">
    ...
    <div class="form-group">
        ...
        <textarea name="description"  cols="30" rows="10" maxlength="10000" class="form-control" id="editor1"></textarea>
